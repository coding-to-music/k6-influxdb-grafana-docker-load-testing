...
export let http_req_status_not_200_error_counter = new Counter(
  "http_req_status_not_200_error_count"
);
export let http_req_blocked_error_counter = new Counter(
  "http_req_blocked_error_count"
);
export let http_req_waiting_error_counter = new Counter(
  "http_req_waiting_error_count"
);
export let http_req_duration_error_counter = new Counter(
  "http_req_duration_error_count"
);
